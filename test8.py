"""
TEST-HFCL-SW-NTP-SEC-08  —  Secure NTP (NTS) Operation Verification
=================================================================
Test Objective:
...
# CA certificate
CA_CERT_LOCAL   = "/srv/tftp/cacloudflare.crt"   # cert already in TFTP root on your machine
CA_CERT_TFTP    = "cacloudflare.crt"          # filename on TFTP server
CA_CERT_FLASH   = "1-nts-ca-cert.crt"         # destination on switch flash
TFTP_ROOT       = "/srv/tftp"             # TFTP root on your machine (update if different)
...
def run_test():
 ...
 TEST-HFCL-SW-08  —  Secure NTP (NTS) Operation Verification
=================================================================
Test Objective:
  Verify Secure NTP operations using a CA certificate on the switch.
